...
<head>
    ...
    <meta charset="utf-8">
    <meta name="viewport" content="wpNameth=device-wpNameth, initial-scale=1, shrink-to-fit=no">
...
<body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" pName="ftco-navbar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" pName="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a href="index.html" class="nav-link">Home</a></li>
                    <li class="nav-item dropdown active">
                        <a class="nav-link dropdown-toggle" href="#" pName="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Catalog</a>
    ...
    <section class="ftco-gallery">
        ...
        <div class="container-flupName px-0">
    ...
    <footer class="ftco-footer ftco-section">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-wpNameget mb-4">
                ...
                <div class="col-md">
                    <div class="ftco-footer-wpNameget mb-4 ml-md-5">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        ...
                        </script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hpNameden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
