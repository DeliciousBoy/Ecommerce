...
<head>
	...
	<meta charset="utf-8">
	<meta name="viewport" content="wp_idth=device-wp_idth, initial-scale=1, shrink-to-fit=no">
...
<body class="goto-here">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" p_id="ftco-navbar">
		<div class="container">
			...
			<div class="collapse navbar-collapse" p_id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a href="index.html" class="nav-link">Home</a></li>
					<li class="nav-item dropdown active">
						<a class="nav-link dropdown-toggle" href="#" p_id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Catalog</a>
	...
	<section class="ftco-gallery">
		...
		<div class="container-flup_id px-0">
	...
	<footer class="ftco-footer ftco-section">
		<div class="container">
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-wp_idget mb-4">
				...
				<div class="col-md">
					<div class="ftco-footer-wp_idget mb-4 ml-md-5">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						...
						</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hp_idden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
