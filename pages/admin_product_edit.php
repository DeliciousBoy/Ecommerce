                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pDetails" name="pDetails" value=<?php echo $pDetails ?>>
                                </div>
                                <div class="mb-3">
                                    <label for="pPrice" class="form-label">Price:</label>
                                    <input type="int" class="form-control" id="pPrice" name="pPrice" value=<?php echo $pPrice; ?>>
                                </div>
                                <div class="mb-3">
                                    <label for="pImage" class="form-label">Image: </label>
                                    <input type="int" class="form-control" id="pImage" name="pImage" value=<?php echo $pImage; ?>>
                                </div>
